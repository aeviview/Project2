			...
			<div class="main_contents">
				<div class="main_con_left">
					...
					<div class="login_box">
						...
						%>
						<form action="../member/LoginProcessMap.jsp" method="post">
							...
							<p>
								<input type="checkbox" name="" value="" /><img
						...
						<p style="padding: 10px 0px 10px 10px">
							<span style="font-weight: bold; color: #333;"><%=session.getAttribute("USER_NAME")%>님,</span> 반갑습니다.<br />로그인
							하셨습니다.
						</p>
